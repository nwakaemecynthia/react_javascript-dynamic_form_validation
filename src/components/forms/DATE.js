...
export const DATE = ({ divClass, inputClass, formControl, formHook }) => {
  const initialDate = (formControl["default_value"] && moment(formControl["default_value"]).isValid()) ? moment(formControl["default_value"]).format("YYYY-MM-DD") : "";
